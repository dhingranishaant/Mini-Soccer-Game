...
/**
 * This class manages the painting of all the objects onto the JPanel and sets up the game.
 */
public class GamePanel extends JPanel {
	...
	/**
	 * The SoccerGame instance.
	 */
	private SoccerGame game;

	/**
	 * Initializes the background color, soccer game, and the repainting of the JPanel.
	 */
	public GamePanel() {
		super(null);
	...
	/**
	 * Sets up the repainting timer of the JPanel.
	 */
	...
	/**
	 * Gets the SoccerGame instance.
	 * @return SoccerGame instance.
	 */
	...
	/**
	 * Paints all the objects onto the JPanel.
	 */
	@Override
	...
	/**
	 * Displays the paused text if the game is paused.
	 * @param g Graphics object to be used to paint.
	 */
	...
	/**
	 * Paints the Goalkeepers goal and its text.
	 * @param g Graphics object to be used to paint.
	 */
	...
	/**
	 * Paints the Goalkeepers line that the player cannot pass.
	 * @param g Graphics object to be used to paint.
	 */
	...
	/**
	 * Displays the text of the time remaining in the game.
	 * @param g Graphics object to be used to paint.
	 */
	...
	/**
	 * Displays the amount of goals the Striker got.
	 * @param g Graphics object to be used to paint.
	 */
	...
	/**
	 * Paints the players in the PlayerCollection instance with their respective colors.
	 * @param g Graphics object to be used to paint.
	 */
	...
	/**
	 * Displays the statistics of the players after the game is over.
	 * @param g Graphics object to be used to paint.
	 */
